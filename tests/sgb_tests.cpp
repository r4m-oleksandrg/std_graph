...
#include "graph/container/sgb_graph.hpp"
...
#if 1
using std::graph::container::sgb_graph;
using std::graph::container::sgb_vertex;
using std::graph::container::sgb_edge;

std::vector<std::pair<long,long>> raw_edges = {{0, 1}, {0, 4}, {0, 6}, {1, 2}, {2, 3}, {3, 8}, {4, 5}, {4, 7}, {5, 8}, {5, 9}, {6, 8}};

sgb_graph* g = gb_new_graph(10);
